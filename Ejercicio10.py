...
numeroDePayasosVendido=int(input("Ingresa el número de payasos vendidos en el último pedido: \n"))
numeroDeMuñecasVendido=int(input("Ingresa el número de muñecas vendidas en el último pedido: \n"))

pesoTotalDelPaquete=((numeroDePayasosVendido*112) + (numeroDeMuñecasVendido*75))

print("El peso total del paquete que será enviado es: " + str(pesoTotalDelPaquete) + " g")